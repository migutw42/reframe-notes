...
var G__62629 = (function (){var G__62630 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__62630) : f.call(null,G__62630));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__62629) : rewrite_clj.node.coerce.call(null,G__62629));
});
/**
...
var G__62680 = (i__4737__auto___62678 + (1));
i__4737__auto___62678 = G__62680;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__62631_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__62631_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq62632){
var G__62633 = cljs.core.first(seq62632);
var seq62632__$1 = cljs.core.next(seq62632);
var G__62634 = cljs.core.first(seq62632__$1);
var seq62632__$2 = cljs.core.next(seq62632__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62633,G__62634,seq62632__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__62653 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__62653) : str_fn.call(null,G__62653));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__62657 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__62657) : str_fn.call(null,G__62657));
})()):null)));
...
var G__62663 = rewrite_clj.zip.base.tag(zloc);
var G__62663__$1 = (((G__62663 instanceof cljs.core.Keyword))?G__62663.fqn:null);
switch (G__62663__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__62660_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__62660_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__62662_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__62662_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62663__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__62667 = rewrite_clj.zip.base.tag(zloc);
var G__62667__$1 = (((G__62667 instanceof cljs.core.Keyword))?G__62667.fqn:null);
switch (G__62667__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__62666_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__62666_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62667__$1)].join('')));
