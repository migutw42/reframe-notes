...
var len__4736__auto___54518 = arguments.length;
var i__4737__auto___54523 = (0);
while(true){
if((i__4737__auto___54523 < len__4736__auto___54518)){
args__4742__auto__.push((arguments[i__4737__auto___54523]));

var G__54524 = (i__4737__auto___54523 + (1));
i__4737__auto___54523 = G__54524;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq54459){
var G__54460 = cljs.core.first(seq54459);
var seq54459__$1 = cljs.core.next(seq54459);
var G__54461 = cljs.core.first(seq54459__$1);
var seq54459__$2 = cljs.core.next(seq54459__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54460,G__54461,seq54459__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__54485_SHARP_){
return (!((cljs.core.meta(p1__54485_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54502__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e54506){var _e__53850__auto__ = e54506;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e54508){var _e__53850__auto__ = e54508;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__54511 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__54512 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__54512);

try{var map__54513 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54513__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__54511);
}});
...
var temp__5733__auto___54528 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___54528)){
var managed_print_level_54529 = temp__5733__auto___54528;
var _STAR_print_level_STAR__orig_val__54516_54530 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__54517_54531 = managed_print_level_54529;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__54517_54531);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__54515_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__54515_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__54516_54530);
}} else {
job_fn();
}
