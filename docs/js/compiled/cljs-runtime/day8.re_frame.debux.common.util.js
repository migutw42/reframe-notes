...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__74733){
var vec__74734 = p__74733;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74734,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74734,(1),null);
...
return clojure.zip.zipper((function (p1__74739_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__74739_SHARP_)) || (cljs.core.map_QMARK_(p1__74739_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__74741){
var vec__74742 = p__74741;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74742,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74742,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__74749_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__74749_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__74748_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__74748_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__74750_SHARP_){
return (((p1__74750_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__74750_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__74754,mapping){
var map__74755 = p__74754;
var map__74755__$1 = (((((!((map__74755 == null))))?(((((map__74755.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__74755.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__74755):map__74755);
var state = map__74755__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74755__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74755__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74755__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__74753_SHARP_){
if((p1__74753_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__74753_SHARP_);
} else {
return false;
}
}),day8.re_frame.debux.common.util.form_tree_seq(form)));
...
var G__74819 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__74822 = clojure.zip.next(loc);
loc = G__74822;
continue;
}
}
...
var len__4736__auto___74839 = arguments.length;
var i__4737__auto___74840 = (0);
while(true){
if((i__4737__auto___74840 < len__4736__auto___74839)){
args__4742__auto__.push((arguments[i__4737__auto___74840]));

var G__74841 = (i__4737__auto___74840 + (1));
i__4737__auto___74840 = G__74841;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__74766){
var vec__74767 = p__74766;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74767,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq74764){
var G__74765 = cljs.core.first(seq74764);
var seq74764__$1 = cljs.core.next(seq74764);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74765,seq74764__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__74770_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__74770_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__74772_74843 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__74773_74844 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__74774_74845 = true;
var _STAR_print_fn_STAR__temp_val__74775_74846 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__74774_74845);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__74775_74846);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__74773_74844);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__74772_74843);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__74771_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__74771_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__74847 = cljs.core.next(opts__$1);
var G__74848 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__74847;
acc = G__74848;
continue;
} else {
if(typeof f === 'string'){
var G__74849 = cljs.core.next(opts__$1);
var G__74850 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__74849;
acc = G__74850;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__74851 = cljs.core.nnext(opts__$1);
var G__74852 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__74851;
acc = G__74852;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__74853 = cljs.core.next(opts__$1);
var G__74854 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__74853;
acc = G__74854;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__74787 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__74787.cljs$core$IFn$_invoke$arity$1 ? fexpr__74787.cljs$core$IFn$_invoke$arity$1(f) : fexpr__74787.call(null,f));
})())){
var G__74855 = cljs.core.next(opts__$1);
var G__74856 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__74855;
acc = G__74856;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__74792 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__74792.cljs$core$IFn$_invoke$arity$1 ? fexpr__74792.cljs$core$IFn$_invoke$arity$1(f) : fexpr__74792.call(null,f));
})())){
var G__74857 = cljs.core.nnext(opts__$1);
var G__74858 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__74857;
acc = G__74858;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__74859 = cljs.core.next(opts__$1);
var G__74860 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__74859;
acc = G__74860;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__74794){
var vec__74795 = p__74794;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74795,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74795,(1),null);
...
var G__74800 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__74799 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__74799.cljs$core$IFn$_invoke$arity$1 ? fexpr__74799.cljs$core$IFn$_invoke$arity$1(G__74800) : fexpr__74799.call(null,G__74800));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__74802 = quoted_form;
var G__74803 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__74802,G__74803) : day8.re_frame.debux.common.util.remove_d.call(null,G__74802,G__74803));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__74804 = quoted_form;
var G__74805 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__74804,G__74805) : day8.re_frame.debux.common.util.remove_d.call(null,G__74804,G__74805));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__74862__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__74806 = quoted_form;
var G__74807 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__74806,G__74807) : day8.re_frame.debux.common.util.remove_d.call(null,G__74806,G__74807));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__74867__i = 0, G__74867__a = new Array(arguments.length -  0);
while (G__74867__i < G__74867__a.length) {G__74867__a[G__74867__i] = arguments[G__74867__i + 0]; ++G__74867__i;}
  arg = new cljs.core.IndexedSeq(G__74867__a,0,null);
} 
return G__74862__delegate.call(this,arg);};
G__74862.cljs$lang$maxFixedArity = 0;
G__74862.cljs$lang$applyTo = (function (arglist__74868){
var arg = cljs.core.seq(arglist__74868);
return G__74862__delegate(arg);
});
...
var G__74877 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__74877;
continue;
} else {
...
var G__74879 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__74879;
continue;
} else {
var G__74882 = clojure.zip.next(loc);
loc = G__74882;
continue;
