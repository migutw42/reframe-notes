...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k61505,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61505,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__61511){
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61504){
var self__ = this;
var G__61504__$1 = this;
return (new cljs.core.RecordIter((0),G__61504__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61506,other61507){
var self__ = this;
var this61506__$1 = this;
return (((!((other61507 == null)))) && ((this61506__$1.constructor === other61507.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61506__$1.children,other61507.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61506__$1.__extmap,other61507.__extmap)));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__61504){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__61524 = cljs.core.keyword_identical_QMARK_;
var expr__61525 = k__4388__auto__;
if(cljs.core.truth_((pred__61524.cljs$core$IFn$_invoke$arity$2 ? pred__61524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__61525) : pred__61524.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__61525)))){
return (new rewrite_clj.node.forms.FormsNode(G__61504,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__61504),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__61504){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__61504,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__61509){
var extmap__4419__auto__ = (function (){var G__61529 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__61509,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__61509)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61529);
} else {
return G__61529;
}
})();
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__61509),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
