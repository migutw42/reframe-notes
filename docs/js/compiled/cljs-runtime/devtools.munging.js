...
var o54185 = temp__5733__auto__;
var temp__5733__auto____$1 = (o54185["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o54186 = temp__5733__auto____$1;
return (o54186["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__53800__auto__ = f;
return (o__53800__auto__["toString"]).call(o__53800__auto__);
} else {
return "";
}
}catch (e54191){var _ = e54191;
return "";
}});
...
try{var o__53800__auto___54402 = t;
(o__53800__auto___54402["cljs$lang$ctorPrWriter"]).call(o__53800__auto___54402,t,writer);
}catch (e54195){var __54403 = e54195;
}
...
var char_code = (function (){var o__53800__auto__ = (new String(char$));
return (o__53800__auto__["charCodeAt"]).call(o__53800__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__53800__auto__ = String;
return (o__53800__auto__["fromCharCode"]).call(o__53800__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__54203 = num_code;
switch (G__54203) {
case (1):
return (185);
...
var o__53800__auto__ = String;
return (o__53800__auto__["fromCharCode"]).call(o__53800__auto__,superscript_code);
});
/**
...
}catch (e54213){var _e__53850__auto__ = e54213;
return false;
}})())){
...
var vec__54216 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54216,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__54234){
var vec__54235 = p__54234;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54235,(0),null);
...
var G__54431 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__54432 = cljs.core.butlast(remaining_tokens);
name_tokens = G__54431;
remaining_tokens = G__54432;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq54229){
...
var vec__54250 = cljs.core.split_with((function (p1__54248_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__54248_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54250,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54250,(1),null);
...
var vec__54260 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54260,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54260,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__54435 = cljs.core.rest(remaining_tokens);
var G__54436 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__54435;
name_tokens = G__54436;
continue;
} else {
...
var vec__54265 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54265,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54265,(1),null);
var vec__54268 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54268,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54268,(1),null);
var vec__54271 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54271,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54271,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54271,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54271,(3),null);
...
var vec__54279 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__54282 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54282,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54282,(1),null);
var vec__54291 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54291,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54291,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__54294 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__54294) : devtools.munging.parse_fn_info_deep.call(null,G__54294));
})()));
}
} else {
return fn_info;
...
var G__54456 = (arity + (1));
var G__54457 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__54306){
var vec__54307 = p__54306;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54307,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54307,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54313_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__54313_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54314_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__54314_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__54318){
var vec__54319 = p__54318;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54319,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq54316){
var G__54317 = cljs.core.first(seq54316);
var seq54316__$1 = cljs.core.next(seq54316);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54317,seq54316__$1);
}));
...
var G__54328 = arg;
var G__54328__$1 = (((G__54328 instanceof cljs.core.Keyword))?G__54328.fqn:null);
switch (G__54328__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54340__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54340__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54340__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54340__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__54341 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54341,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54341,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54341,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54341,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54341,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54341,(5),null);
...
var o__53800__auto__ = f;
return (o__53800__auto__["getBasis"]).call(o__53800__auto__);
});
/**
...
}catch (e54355){var _e__53850__auto__ = e54355;
...
var G__54497 = (obj[cljs.core.first(path)]);
var G__54498 = cljs.core.rest(path);
obj = G__54497;
path = G__54498;
continue;
} else {
...
var _STAR_ = (function (accum,p__54373){
var vec__54376 = p__54373;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54376,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54376,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__54383){
var vec__54384 = p__54383;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54384,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54384,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54384,(2),null);
...
var post_process = (function (p__54394){
var vec__54395 = p__54394;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54395,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54395,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54390_SHARP_){
return (obj[cljs.core.first(p1__54390_SHARP_)]);
}),sorted_matches);
