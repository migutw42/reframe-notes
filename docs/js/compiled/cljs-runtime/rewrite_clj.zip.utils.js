...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__62463,k,f){
var vec__62475 = p__62463;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62475,(0),null);
...
var G__62558 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__62558;
continue;
}
break;
...
var G__62559 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__62559;
continue;
} else {
return zloc__$1;
...
var G__62560 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__62560;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__62503){
var vec__62505 = p__62503;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62505,(0),null);
var map__62508 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62505,(1),null);
...
var path = map__62508__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62508__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__62505;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__62514){
var vec__62515 = p__62514;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62515,(0),null);
var map__62518 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62515,(1),null);
var map__62518__$1 = (((((!((map__62518 == null))))?(((((map__62518.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62518.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62518):map__62518);
var path = map__62518__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62518__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__62515;
if(cljs.core.seq(r)){
...
var vec__62542 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62542,(0),null);
var map__62545 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62542,(1),null);
...
var path = map__62545__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62545__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62545__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62545__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62545__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
