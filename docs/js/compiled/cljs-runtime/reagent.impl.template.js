...
var G__64215 = o;
goog.object.set(G__64215,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__64359__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__64359 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__64360__i = 0, G__64360__a = new Array(arguments.length -  0);
while (G__64360__i < G__64360__a.length) {G__64360__a[G__64360__i] = arguments[G__64360__i + 0]; ++G__64360__i;}
  args = new cljs.core.IndexedSeq(G__64360__a,0,null);
} 
return G__64359__delegate.call(this,args);};
G__64359.cljs$lang$maxFixedArity = 0;
G__64359.cljs$lang$applyTo = (function (arglist__64361){
var args = cljs.core.seq(arglist__64361);
return G__64359__delegate(args);
});
G__64359.cljs$core$IFn$_invoke$arity$variadic = G__64359__delegate;
return G__64359;
})()
;
} else {
...
var G__64233 = o;
goog.object.set(G__64233,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__64366__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__64366 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__64369__i = 0, G__64369__a = new Array(arguments.length -  0);
while (G__64369__i < G__64369__a.length) {G__64369__a[G__64369__i] = arguments[G__64369__i + 0]; ++G__64369__i;}
  args = new cljs.core.IndexedSeq(G__64369__a,0,null);
} 
return G__64366__delegate.call(this,args);};
G__64366.cljs$lang$maxFixedArity = 0;
G__64366.cljs$lang$applyTo = (function (arglist__64370){
var args = cljs.core.seq(arglist__64370);
return G__64366__delegate(args);
});
G__64366.cljs$core$IFn$_invoke$arity$variadic = G__64366__delegate;
return G__64366;
})()
;
} else {
...
var G__64243 = props;
var G__64243__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64243,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__64243);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64243__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__64243__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__64249 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64249,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__64249;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__64258){
var map__64260 = p__64258;
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64260__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__64277_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__64277_SHARP_);
}));
} else {
return null;
}
...
var vec__64295 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64295,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64295,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64295,(2),null);
...
var temp__5739__auto___64393 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___64393 == null)){
} else {
var key_64399 = temp__5739__auto___64393;
(jsprops.key = key_64399);
}
...
var temp__5739__auto___64408 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___64408 == null)){
} else {
var key_64410 = temp__5739__auto___64408;
(jsprops.key = key_64410);
}
...
var G__64317 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__64317) : reagent.impl.template.as_element.call(null,G__64317));
} else {
var temp__5739__auto___64433 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___64433 == null)){
} else {
var key_64434 = temp__5739__auto___64433;
(jsprops.key = key_64434);
}
...
var G__64323 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__64323)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__64323)){
return x;
} else {
...
var len__4736__auto___64439 = arguments.length;
var i__4737__auto___64441 = (0);
while(true){
if((i__4737__auto___64441 < len__4736__auto___64439)){
args__4742__auto__.push((arguments[i__4737__auto___64441]));

var G__64446 = (i__4737__auto___64441 + (1));
i__4737__auto___64441 = G__64446;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq64326){
var G__64327 = cljs.core.first(seq64326);
var seq64326__$1 = cljs.core.next(seq64326);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64327,seq64326__$1);
}));
...
break;
default:
var G__64461 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__64461;
continue;
...
var ctx = ({});
var vec__64344 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64344,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64344,(1),null);
...
var G__64350 = (cljs.core.count(argv) - first_child);
switch (G__64350) {
case (0):
