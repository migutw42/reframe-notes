...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_57046 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_57046(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_57055 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_57055(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_57068 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_57068(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_57082 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_57082(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_57085 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_57085(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_57086 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_57086(reader);
}
});
...
var G__57139 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__57140 = s.append(c);
c = G__57139;
s = G__57140;
continue;
}
