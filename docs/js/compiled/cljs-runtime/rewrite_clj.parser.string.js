...
if((c === "\n")){
var G__62219 = escape_QMARK_;
var G__62220 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__62219;
lines = G__62220;
continue;
} else {
buf.append(c);

var G__62227 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__62228 = lines;
escape_QMARK_ = G__62227;
lines = G__62228;
continue;
...
var G__62202 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__62202) : rewrite_clj.node.string_node.call(null,G__62202));
});
...
var G__62203 = cljs.core.re_pattern(regex);
var G__62204 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__62203,G__62204) : rewrite_clj.node.token_node.call(null,G__62203,G__62204));
});
