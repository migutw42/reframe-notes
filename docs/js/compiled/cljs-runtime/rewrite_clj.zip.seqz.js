...
var G__62694 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__62694__$1 = (((G__62694 == null))?null:cljs.core.iterate((function (loc){
...
var G__62694__$2 = (((G__62694__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__62694__$1));
var G__62694__$3 = (((G__62694__$2 == null))?null:cljs.core.last(G__62694__$2));
if((G__62694__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__62694__$3);
}
} else {
return zloc;
}
...
var G__62726 = rewrite_clj.zip.move.right(v);
var G__62727 = rewrite_clj.zip.move.up(v);
loc = G__62726;
parent = G__62727;
continue;
} else {
var G__62728 = rewrite_clj.zip.move.right(v0);
var G__62729 = parent;
loc = G__62728;
parent = G__62729;
continue;
...
var G__62731 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__62732 = rewrite_clj.zip.move.up(v);
loc = G__62731;
parent = G__62732;
continue;
} else {
var G__62733 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__62734 = parent;
loc = G__62733;
parent = G__62734;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__62717 = zloc;
var G__62717__$1 = (((G__62717 == null))?null:rewrite_clj.zip.move.down(G__62717));
var G__62717__$2 = (((G__62717__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__62717__$1,k));
if((G__62717__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__62717__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__62723 = rewrite_clj.zip.move.down(zloc);
var G__62723__$1 = (((G__62723 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__62723));
if((G__62723__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__62723__$1);
}
})(),k);
}
});
