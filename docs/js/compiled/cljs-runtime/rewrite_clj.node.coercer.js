...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__62164 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__62164) : f.call(null,G__62164));
})(),sq);
});
...
var comma_62180 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_62181 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__62168){
var vec__62172 = p__62168;
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_62181,rewrite_clj.node.protocols.coerce(v),comma_62180], null);
