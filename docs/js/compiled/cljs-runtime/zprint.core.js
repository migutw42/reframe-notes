...
var vec__65583 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__65586 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65586,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65586,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65583,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65583,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__65593){
var vec__65594 = p__65593;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65594,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65594,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65597,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65597,(1),null);
...
var vec__65612 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65612,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65612,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65612,(2),null);
var vec__65615 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65615,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65615,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65615,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__65620){
var vec__65622 = p__65620;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65622,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65622,(1),null);
...
var len__4736__auto___65707 = arguments.length;
var i__4737__auto___65708 = (0);
while(true){
if((i__4737__auto___65708 < len__4736__auto___65707)){
args__4742__auto__.push((arguments[i__4737__auto___65708]));

var G__65709 = (i__4737__auto___65708 + (1));
i__4737__auto___65708 = G__65709;
continue;
} else {
}
break;
...
var vec__65631 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65631,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65631,(1),null);
...
var G__65634 = zprint.core.parse_string_all_options(rest_options);
var G__65635 = zprint.core.zprint_str_internal;
var G__65636 = ":parse-string-all? call";
var G__65637 = (function (){var G__65638 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__65638) : zprint.zutil.edn_STAR_.call(null,G__65638));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__65634,G__65635,G__65636,G__65637) : zprint.core.process_multiple_forms.call(null,G__65634,G__65635,G__65636,G__65637));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__65640 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65640,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65640,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq65627){
var G__65628 = cljs.core.first(seq65627);
var seq65627__$1 = cljs.core.next(seq65627);
var G__65629 = cljs.core.first(seq65627__$1);
var seq65627__$2 = cljs.core.next(seq65627__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65628,G__65629,seq65627__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___65713 = arguments.length;
var i__4737__auto___65714 = (0);
while(true){
if((i__4737__auto___65714 < len__4736__auto___65713)){
args__4742__auto__.push((arguments[i__4737__auto___65714]));

var G__65715 = (i__4737__auto___65714 + (1));
i__4737__auto___65714 = G__65715;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq65653){
...
var args__4742__auto__ = [];
var len__4736__auto___65722 = arguments.length;
var i__4737__auto___65723 = (0);
while(true){
if((i__4737__auto___65723 < len__4736__auto___65722)){
args__4742__auto__.push((arguments[i__4737__auto___65723]));

var G__65724 = (i__4737__auto___65723 + (1));
i__4737__auto___65723 = G__65724;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq65664){
var G__65668 = cljs.core.first(seq65664);
var seq65664__$1 = cljs.core.next(seq65664);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65668,seq65664__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___65729 = arguments.length;
var i__4737__auto___65730 = (0);
while(true){
if((i__4737__auto___65730 < len__4736__auto___65729)){
args__4742__auto__.push((arguments[i__4737__auto___65730]));

var G__65731 = (i__4737__auto___65730 + (1));
i__4737__auto___65730 = G__65731;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq65679){
var G__65680 = cljs.core.first(seq65679);
var seq65679__$1 = cljs.core.next(seq65679);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65680,seq65679__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___65732 = arguments.length;
var i__4737__auto___65733 = (0);
while(true){
if((i__4737__auto___65733 < len__4736__auto___65732)){
args__4742__auto__.push((arguments[i__4737__auto___65733]));

var G__65734 = (i__4737__auto___65733 + (1));
i__4737__auto___65733 = G__65734;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq65683){
var G__65684 = cljs.core.first(seq65683);
var seq65683__$1 = cljs.core.next(seq65683);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65684,seq65683__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__65689,form){
var vec__65690 = p__65689;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65690,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65690,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65690,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65690,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__65693 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65693,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65693,(1),null);
...
var forms = (function (){var G__65699 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__65699) : zprint.zutil.edn_STAR_.call(null,G__65699));
})();
