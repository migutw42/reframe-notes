...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__61119_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__61119_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__61119_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__61120){
var vec__61121 = p__61120;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61121,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61121,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__61126,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61127__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61127__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61127__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__61133 = (function (){var or__4126__auto__ = color;
...
var fexpr__61132 = (function (){var G__61134 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__61134) : style_map.call(null,G__61134));
})();
return (fexpr__61132.cljs$core$IFn$_invoke$arity$1 ? fexpr__61132.cljs$core$IFn$_invoke$arity$1(G__61133) : fexpr__61132.call(null,G__61133));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__61140){
var vec__61142 = p__61140;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61142,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61142,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61142,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__61145){
var vec__61146 = p__61145;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61146,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61146,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61146,(2),null);
...
var G__61369 = cljs.core.next(ssv);
var G__61370 = (this_ssv == null);
var G__61371 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__61372 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__61369;
doing_nil_QMARK_ = G__61370;
last_elide = G__61371;
out = G__61372;
continue;
}
...
var vec__61183 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61183,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61183,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61183,(2),null);
...
var G__61374 = cljs.core.next(remaining_cvec);
var G__61375 = new_idx;
var G__61376 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__61374;
idx = G__61375;
out = G__61376;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__61291,cursor_vec){
var vec__61292 = p__61291;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61292,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61292,(1),null);
var focus_vec = vec__61292;
...
var vec__61295 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61295,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61295,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__61306){
var vec__61307 = p__61306;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61307,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61307,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__61318,existing_count){
var vec__61319 = p__61318;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61319,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61319,(1),null);
...
return cljs.core.filterv((function (p1__61312_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__61312_SHARP_))));
...
var vec__61330 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61330,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61330,(1),null);
var cvec_element = vec__61330;
if((cvec_element == null)){
var G__61414 = cljs.core.next(cvec_nl);
var G__61415 = (idx + (1));
var G__61416 = start;
var G__61417 = out;
cvec_nl = G__61414;
...
var G__61418 = cljs.core.next(cvec_nl);
var G__61419 = (idx + (1));
var G__61420 = idx;
var G__61421 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__61418;
idx = G__61419;
start = G__61420;
out = G__61421;
...
var G__61425 = cljs.core.next(cvec_nl);
var G__61426 = (idx + (1));
var G__61427 = (idx + (1));
var G__61428 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__61425;
idx = G__61426;
start = G__61427;
out = G__61428;
...
var G__61442 = cljs.core.next(cvec_nl);
var G__61443 = (idx + (1));
var G__61444 = idx;
...
var G__61446 = cljs.core.next(cvec_nl);
var G__61447 = (idx + (1));
var G__61448 = start;
var G__61449 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__61446;
idx = G__61447;
start = G__61448;
out = G__61449;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__61335_SHARP_,p2__61334_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__61334_SHARP_)){
return cljs.core.reduced(p1__61335_SHARP_);
} else {
return (p1__61335_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__61338,p__61339){
var vec__61340 = p__61338;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61340,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61340,(1),null);
var vec__61343 = p__61339;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61343,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61343,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__61353,cvec,focus_vec){
...
var options = map__61354__$1;
var map__61355 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61354__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61355__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61355__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61355__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61352_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__61352_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
