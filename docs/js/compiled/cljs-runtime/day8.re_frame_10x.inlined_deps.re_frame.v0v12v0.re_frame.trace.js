...
day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v0v12v0$re_frame$trace$start_trace(p__60646){
...
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60647__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60647__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60647__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60647__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__60649_60693 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.trace.trace_cbs));
var chunk__60650_60694 = null;
var count__60651_60695 = (0);
var i__60652_60696 = (0);
while(true){
if((i__60652_60696 < count__60651_60695)){
var vec__60663_60697 = chunk__60650_60694.cljs$core$IIndexed$_nth$arity$2(null,i__60652_60696);
var k_60698 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60663_60697,(0),null);
var cb_60699 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60663_60697,(1),null);
try{var G__60667_60703 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.trace.traces);
(cb_60699.cljs$core$IFn$_invoke$arity$1 ? cb_60699.cljs$core$IFn$_invoke$arity$1(G__60667_60703) : cb_60699.call(null,G__60667_60703));
}catch (e60666){var e_60704 = e60666;
day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_60698,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.trace.traces),e_60704], 0));
}

var G__60706 = seq__60649_60693;
var G__60707 = chunk__60650_60694;
var G__60708 = count__60651_60695;
var G__60709 = (i__60652_60696 + (1));
seq__60649_60693 = G__60706;
chunk__60650_60694 = G__60707;
count__60651_60695 = G__60708;
i__60652_60696 = G__60709;
continue;
} else {
var temp__5735__auto___60711 = cljs.core.seq(seq__60649_60693);
if(temp__5735__auto___60711){
var seq__60649_60712__$1 = temp__5735__auto___60711;
if(cljs.core.chunked_seq_QMARK_(seq__60649_60712__$1)){
var c__4556__auto___60713 = cljs.core.chunk_first(seq__60649_60712__$1);
var G__60714 = cljs.core.chunk_rest(seq__60649_60712__$1);
var G__60715 = c__4556__auto___60713;
var G__60716 = cljs.core.count(c__4556__auto___60713);
var G__60717 = (0);
seq__60649_60693 = G__60714;
chunk__60650_60694 = G__60715;
count__60651_60695 = G__60716;
i__60652_60696 = G__60717;
continue;
} else {
var vec__60668_60718 = cljs.core.first(seq__60649_60712__$1);
var k_60719 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60668_60718,(0),null);
var cb_60720 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60668_60718,(1),null);
try{var G__60672_60721 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.trace.traces);
(cb_60720.cljs$core$IFn$_invoke$arity$1 ? cb_60720.cljs$core$IFn$_invoke$arity$1(G__60672_60721) : cb_60720.call(null,G__60672_60721));
}catch (e60671){var e_60722 = e60671;
day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_60719,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.trace.traces),e_60722], 0));
}

var G__60723 = cljs.core.next(seq__60649_60712__$1);
var G__60724 = null;
var G__60725 = (0);
var G__60726 = (0);
seq__60649_60693 = G__60723;
chunk__60650_60694 = G__60724;
count__60651_60695 = G__60725;
i__60652_60696 = G__60726;
continue;
}
} else {
}
