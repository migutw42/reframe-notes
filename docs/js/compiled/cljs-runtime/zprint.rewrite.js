...
var G__63329 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__63329;
continue;
} else {
var G__63330 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__63330;
continue;
}
} else {
var G__63331 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__63331;
continue;
}
}
...
var G__63300 = zloc;
var G__63301 = (function (){var G__63302 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__63303 = zloc;
var G__63303__$1 = (((G__63303 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__63303) : rewrite_clj.zip.node.call(null,G__63303)));
if((G__63303__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__63303__$1) : zprint.zutil.edn_STAR_.call(null,G__63303__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__63302) : rewrite_clj.zip.root.call(null,G__63302));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__63300,G__63301) : rewrite_clj.zip.replace.call(null,G__63300,G__63301));
});
/**
...
var G__63342 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__63342;
continue;
}
break;
...
var G__63345 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__63346 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__63345;
out = G__63346;
continue;
} else {
...
var G__63349 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__63350 = cljs.core.next(new_loc);
var G__63351 = replaced_loc;
nloc = G__63349;
new_loc = G__63350;
last_loc = G__63351;
continue;
...
return zprint.rewrite.sort_val((function (){var G__63322 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__63322) : rewrite_clj.zip.down.call(null,G__63322));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__63324_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__63324_SHARP_) : rewrite_clj.zip.tag.call(null,p1__63324_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__63324_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__63324_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
