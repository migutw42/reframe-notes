...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__61222){
var map__61225 = p__61222;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61225__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61225__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61225__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61225__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61225__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61273){
var vec__61274 = p__61273;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61274,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61274,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61271_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__61271_SHARP_,/:/);
...
var G__61429 = (i__4737__auto___61424 + (1));
i__4737__auto___61424 = G__61429;
continue;
} else {
}
break;
...
var previous_config__61193__auto__ = devtools.prefs.get_prefs();
var prefs__61194__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__61194__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__61194__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__61194__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__61193__auto__);
}}));

(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq61298){
var G__61299 = cljs.core.first(seq61298);
var seq61298__$1 = cljs.core.next(seq61298);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61299,seq61298__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___61433 = arguments.length;
var i__4737__auto___61435 = (0);
while(true){
if((i__4737__auto___61435 < len__4736__auto___61433)){
args__4742__auto__.push((arguments[i__4737__auto___61435]));

var G__61439 = (i__4737__auto___61435 + (1));
i__4737__auto___61435 = G__61439;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq61310){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61310));
}));
...
var G__61452 = (i__4737__auto___61451 + (1));
i__4737__auto___61451 = G__61452;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq61315){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61315));
}));
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq61324){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61324));
}));
...
var expanded_QMARK_ = (function (){var G__61336 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61336) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__61336));
})();
...
var G__61337 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path__$1], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61337) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.call(null,G__61337));
...
})())?(function (){var G__61347 = day8.re_frame_10x.view.components.cljs_devtools_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__61348 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__61347,G__61348) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__61347,G__61348));
})():(function (){var G__61349 = day8.re_frame_10x.view.components.cljs_devtools_header.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__61350 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"header","header",119441134));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__61349,G__61350) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__61349,G__61350));
})())], null);
});
});
/**
...
var vec__61358 = jsonml;
var seq__61359 = cljs.core.seq(vec__61358);
var first__61360 = cljs.core.first(seq__61359);
var seq__61359__$1 = cljs.core.next(seq__61359);
var tag_name = first__61360;
var first__61360__$1 = cljs.core.first(seq__61359__$1);
var seq__61359__$2 = cljs.core.next(seq__61359__$1);
var attributes = first__61360__$1;
var children = seq__61359__$2;
...
var G__61362 = child;
var G__61363 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,i);
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__61362,G__61363) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__61362,G__61363));
})),children);
} else {
...
var expanded_QMARK_ = (function (){var G__61365 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61365) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__61365));
})();
...
var G__61366 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61366) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.call(null,G__61366));
...
var args__4742__auto__ = [];
var len__4736__auto___61479 = arguments.length;
var i__4737__auto___61480 = (0);
while(true){
if((i__4737__auto___61480 < len__4736__auto___61479)){
args__4742__auto__.push((arguments[i__4737__auto___61480]));

var G__61481 = (i__4737__auto___61480 + (1));
i__4737__auto___61480 = G__61481;
continue;
} else {
}
break;
...
(day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__61382){
var vec__61383 = p__61382;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61383,(0),null);
var expanded_QMARK_ = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return (function (data__$1){
...
/** @this {Function} */
(day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq61379){
var G__61380 = cljs.core.first(seq61379);
var seq61379__$1 = cljs.core.next(seq61379);
var G__61381 = cljs.core.first(seq61379__$1);
var seq61379__$2 = cljs.core.next(seq61379__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61380,G__61381,seq61379__$2);
}));
