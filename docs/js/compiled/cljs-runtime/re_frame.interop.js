...
return [(function (){var pred__64602 = cljs.core.instance_QMARK_;
var expr__64603 = reactive_val;
if(cljs.core.truth_((pred__64602.cljs$core$IFn$_invoke$arity$2 ? pred__64602.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__64603) : pred__64602.call(null,reagent.ratom.RAtom,expr__64603)))){
return "ra";
} else {
if(cljs.core.truth_((pred__64602.cljs$core$IFn$_invoke$arity$2 ? pred__64602.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__64603) : pred__64602.call(null,reagent.ratom.RCursor,expr__64603)))){
return "rc";
} else {
if(cljs.core.truth_((pred__64602.cljs$core$IFn$_invoke$arity$2 ? pred__64602.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__64603) : pred__64602.call(null,reagent.ratom.Reaction,expr__64603)))){
return "rx";
} else {
if(cljs.core.truth_((pred__64602.cljs$core$IFn$_invoke$arity$2 ? pred__64602.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__64603) : pred__64602.call(null,reagent.ratom.Track,expr__64603)))){
return "tr";
} else {
return "other";
}
